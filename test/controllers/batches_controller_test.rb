...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { banner_url: @batch.banner_url, name: @batch.name } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { banner_url: @batch.banner_url, name: @batch.name } }
